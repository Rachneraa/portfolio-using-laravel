<x-layouts.app :title="'Home'" :socialMedia="$socialMedia">
    <!-- Hero Section -->
    <section id="home" class="min-h-screen flex items-center bg-gradient-to-b from-[#F2E7DD] to-[#F2D6CE]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <!-- Left Content -->
                <div class="order-2 md:order-1">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-[#292421] mb-4" data-aos="fade-up">
                        Hi I'm <span class="text-[#A75F37]">{{ $hero->name ?? 'Fadilla Tasya Wanda' }}</span>
                    </h1>
                    <p class="text-[#292421]/70 text-lg mb-8" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="flex gap-4" data-aos="fade-up" data-aos-delay="200">
                        @if($hero && $hero->cv_file)
                            <a href="{{ route('download.cv') }}"
                                class="bg-[#A75F37] hover:bg-[#8B4F2E] text-white px-6 py-3 rounded-full font-medium transition flex items-center gap-2">
                        ...
                        @endif
                        <a href="#contact"
                            class="border-2 border-[#292421] hover:bg-[#292421] hover:text-white text-[#292421] px-6 py-3 rounded-full font-medium transition">
                            Contact
                        </a>
                    </div>
                ...
                <div class="flex justify-center order-1 md:order-2" data-aos="fade-up" data-aos-delay="300">
                    <div class="relative">
                        <div class="w-64 h-64 md:w-80 md:h-80 rounded-2xl bg-[#D9B99F] overflow-hidden shadow-xl">
                            @if($hero && $hero->photo)
                                <img src="{{ asset('storage/' . $hero->photo) }}" alt="{{ $hero->name }}" class="w-full h-full object-cover" loading="lazy">
                            @else
                                <div class="w-full h-full flex items-center justify-center bg-[#F2D6CE]">
                                    <svg class="w-32 h-32 text-[#CA8E82]" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                        ...
                        <div class="absolute -bottom-4 -right-4 bg-white rounded-xl p-4 shadow-lg">
                            <p class="font-semibold text-[#292421]">{{ $hero->name ?? 'Fadilla Tasya Wanda' }}</p>
                            <p class="text-sm text-[#A75F37]">{{ $hero->title ?? 'UI Designer' }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- About Section -->
    <section id="about" class="py-20 bg-[#F2D6CE]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-start">
                <!-- Left - Description -->
                <div class="bg-white rounded-2xl p-8 shadow-lg" data-aos="fade-up">
                    <div class="prose prose-neutral max-w-none text-[#292421]">
                    ...
                    <div class="mt-8">
                        <h3 class="text-xl font-bold text-[#292421] mb-4">What I Bring</h3>
                        <ul class="space-y-2">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-[#D9B99F] rounded-xl h-32 overflow-hidden" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="bg-[#D9B99F] rounded-xl h-32 overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="bg-[#D9B99F] rounded-xl h-32 overflow-hidden" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="bg-[#D9B99F] rounded-xl h-32 overflow-hidden" data-aos="fade-up" data-aos-delay="400">
    ...
    @if(isset($sekolahs) && $sekolahs->count())
        <section id="sekolah" class="py-20 bg-[#F2E7DD]">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-center text-[#292421] mb-4" data-aos="fade-up">educational history</h2>
                <div class="relative flex flex-col items-center mt-16">
                    <div class="absolute left-1/2 top-0 bottom-0 w-1 bg-[#E0C3A3] -translate-x-1/2 z-0"></div>
                        ...
                        <div class="relative w-full flex mb-16 z-10 flex-col md:flex-row {{ $isLeft ? '' : 'md:flex-row-reverse' }}">
                            <div class="w-full md:w-1/2 flex {{ $isLeft ? 'md:justify-end md:pr-8' : 'md:justify-start md:pl-8' }} justify-center mb-4 md:mb-0">
                                <div class="max-w-md w-full flex items-center gap-6 {{ $isLeft ? 'md:flex-row-reverse' : '' }} flex-col md:flex-row">
                                        ...
                                        <div class="hidden md:block absolute top-1/2 {{ $isLeft ? 'right-[-44px]' : 'left-[-44px]' }} -translate-y-1/2 w-6 h-6 rounded-full border-4 border-white bg-[#E0C3A3] z-30"></div>
                                        </div>
                                        <div class="bg-white rounded-xl shadow-md px-6 py-4 w-full">
                                            <div class="flex flex-wrap items-center gap-2 mb-1">
                                                <span class="text-lg font-bold text-[#292421]">{{ $sekolah->nama }}</span>
                                                <span class="text-sm font-semibold" style="color: {{ $sekolah->color ?? '#A75F37' }};">({{ $sekolah->tahun_masuk }} - {{ $sekolah->tahun_lulus }})</span>
                                            </div>
                                            @if($sekolah->jurusan)
                                                <div class="text-sm text-[#292421]/70 mb-1">Study program: {{ $sekolah->jurusan }}</div>
                                            @endif
    ...
    <!-- Skills Section -->
    <section id="skills" class="py-20 bg-[#F2E7DD] overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-center text-[#292421] mb-4" data-aos="fade-up">My Skill</h2>
            <p class="text-center text-[#292421]/60 mb-12" data-aos="fade-up" data-aos-delay="100">A blend of technical
                ...
                <div class="marquee-track flex whitespace-nowrap">
                    @foreach($skillsRow1 as $skill)
                        ...
                        <div class="inline-flex items-center gap-3 rounded-full px-6 py-3 mx-3 shadow-sm whitespace-nowrap"
                            ...
                            @endif
                            <span class="font-medium text-[#292421]">{{ $skill->name }}</span>
                        </div>
                    @endforeach
                    {{-- Duplicate for seamless loop --}}
                    @foreach($skillsRow1 as $skill)
                        @php
                            $hex = ltrim($skill->color ?? '#A75F37', '#');
                            $r = hexdec(substr($hex, 0, 2));
                            $g = hexdec(substr($hex, 2, 2));
                            $b = hexdec(substr($hex, 4, 2));
                            $bgColor = "rgba($r, $g, $b, 0.35)";
    ...
    <!-- Projects Section -->
    <section id="projects" class="py-20 bg-[#F2D6CE]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-center text-[#292421] mb-4" data-aos="fade-up">portfolio</h2>
            <p class="text-center text-[#292421]/60 mb-12" data-aos="fade-up" data-aos-delay="100">Browse my portfolio
                to
                ...
                @empty
                    @for($i = 0; $i < 6; $i++)
                        <div class="project-card bg-white rounded-xl overflow-hidden shadow-lg" data-aos="fade-up"
                            ...
                            <div class="h-48 bg-gradient-to-br from-[#F2D6CE] to-[#D9B99F] flex items-center justify-center">
                                <svg class="w-16 h-16 text-[#CA8E82]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z">
                                    </path>
                            ...
                            <div class="p-6">
                                <h3 class="font-bold text-[#A75F37] text-lg mb-2">E-Learning App</h3>
                                <p class="text-[#292421]/70 text-sm mb-4">Lorem ipsum dolor sit amet adipiscing elit</p>
                                <a href="#"
                                    class="text-[#A75F37] hover:text-[#8B4F2E] text-sm font-medium flex items-center gap-1">
                                    View Project
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center mt-12" data-aos="fade-up" data-aos-delay="400">
                <a href="{{ route('projects') }}"
                    class="inline-flex items-center gap-2 bg-[#A75F37] hover:bg-[#8B4F2E] text-white px-8 py-3 rounded-full font-medium transition">
                    Lihat Lebih Banyak
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <section id="experience" class="py-20 bg-[#F2E7DD]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-center text-[#292421] mb-12" data-aos="fade-up">experience</h2>
    ...
    <!-- Contact Section -->
    <section id="contact" class="py-20 bg-[#F2D6CE]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-center text-[#292421] mb-4" data-aos="fade-up">Get in Touch</h2>
            <p class="text-center text-[#292421]/60 mb-12" data-aos="fade-up" data-aos-delay="100">Have a project in
                mind or
            ...
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                    <h3 class="text-xl font-bold text-[#292421] mb-6">Let's Connect</h3>
                    <p class="text-[#292421]/70 mb-8">I'm always open to discussing new projects, creative ideas, or
                        opportunities to be part of your vision.</p>

                    <div class="space-y-4">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 rounded-full bg-[#BAE0DA] flex items-center justify-center">
                                <svg class="w-6 h-6 text-[#7A958F]" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <p class="font-medium text-[#292421]">Email</p>
                                <p class="text-[#292421]/70">Fadillatasya5@gmail.com</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-medium text-[#292421]">Phone</p>
                                <p class="text-[#292421]/70">+62 851-5638-8955</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-medium text-[#292421]">Location</p>
                                <p class="text-[#292421]/70">Mampang Prapatan, Jakarta Selatan, DKI Jakarta, Indonesia
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg" data-aos="fade-up" data-aos-delay="300">
                    <form id="contact-form" class="space-y-6">
                        @csrf
                        <div>
                            <label for="name" class="block text-sm font-medium text-[#292421] mb-2">Name</label>
                            <input type="text" id="name" name="name" required
                                class="w-full px-4 py-3 border border-[#D9B99F] rounded-lg focus:ring-2 focus:ring-[#A75F37] focus:border-transparent"
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium text-[#292421] mb-2">Email</label>
                        ...
                        <div>
                            <label for="message" class="block text-sm font-medium text-[#292421] mb-2">Message</label>
                        ...
                        <button type="submit" id="submit-btn"
                            class="w-full bg-[#A75F37] hover:bg-[#8B4F2E] text-white py-3 rounded-lg font-medium transition flex items-center justify-center gap-2">
